        ...
        const I18N_ZH = {
            ...
            labelContent: '内容搜索', labelContentInput: '搜索内容:', labelDedupe: '去重（硬链接）', labelScope: '目录范围:', labelTypes: '类型:', labelExclude: '排除:', labelMinSize: '最小大小(B):', labelMaxSize: '最大大小(B):', modeTerms: '多词(terms)', labelMaxResults: '最大结果数:',
        ...
        const I18N_EN = {
            ...
            labelContent: 'Content search', labelContentInput: 'Content:', labelDedupe: 'Dedupe (hard links)', labelScope: 'Scope:', labelTypes: 'Types:', labelExclude: 'Exclude:', labelMinSize: 'Min size (B):', labelMaxSize: 'Max size (B):', modeTerms: 'Terms', labelMaxResults: 'Max results:',
