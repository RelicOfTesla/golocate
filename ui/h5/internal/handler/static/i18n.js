        ...
        const I18N_ZH = {
            ...
            searchPlaceholder: '搜索文件名/路径', contentPlaceholder: '搜索内容(可选)', labelIgnoreCase: '忽略大小写', labelBasename: '仅文件名',
            labelMode: '模式:', modeNormal: '普通', modeRegex: '正则', modeWildcard: '通配符',
            labelContent: '内容搜索:', labelContentInput: '', labelDedupe: '去重（硬链接）', labelScope: '目录范围:', labelTypes: '类型:', labelExclude: '排除:', labelMinSize: '最小大小(B):', labelMaxSize: '最大大小(B):', modeTerms: '多词(terms)', labelMaxResults: '最大结果数:',
            ...
            noDirs: '暂无索引目录', pageInfo: '第', open: '打开', openDir: '打开目录', noDirToOpen: '无目录可打开', openFail: '打开失败', opened: '已打开', recentSearches: '最近搜索:', copy: '复制', copyFull: '复制完整路径', copyName: '复制文件名', copiedName: '已复制文件名', copyFail: '复制失败', delete: '删除', favorites: '收藏', favorite: '收藏', unfav: '取消收藏', noFavorites: '暂无收藏',
        ...
        const I18N_EN = {
            ...
            searchPlaceholder: 'Search name/path', contentPlaceholder: 'Content (optional)', labelIgnoreCase: 'Ignore case', labelBasename: 'File name only',
            labelMode: 'Mode:', modeNormal: 'Normal', modeRegex: 'Regex', modeWildcard: 'Wildcard',
            labelContent: 'Content:', labelContentInput: '', labelDedupe: 'Dedupe (hard links)', labelScope: 'Scope:', labelTypes: 'Types:', labelExclude: 'Exclude:', labelMinSize: 'Min size (B):', labelMaxSize: 'Max size (B):', modeTerms: 'Terms', labelMaxResults: 'Max results:',
            ...
            noDirs: 'No index directories', pageInfo: 'Page', open: 'Open', openDir: 'Open dir', noDirToOpen: 'No directory to open', openFail: 'Open failed', opened: 'Opened', recentSearches: 'Recent searches:', copy: 'Copy', copyFull: 'Copy full path', copyName: 'Copy name', copiedName: 'Copied name', copyFail: 'Copy failed', delete: 'Delete', favorites: 'Favorites', favorite: 'Favorite', unfav: 'Unfavorite', noFavorites: 'No favorites yet',
